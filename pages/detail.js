...
import Favourite from "../components/Favourite/LabelledFave"
import "./detail.scss"
...
const DetailPage = ({service}) =>{
    ...
    return(
        <Layout withHeader withFooter>
            ...
            <ColumnsWithDivider>
                <Column>
                    {url && <Button  target="blank" withBottomMargin href={url} onClick={()=>{logEvent("Service detail", "Opened external service website")}}>Visit website</Button>}
                    {(venue || area || postcode) &&
